...
public class FirstAnimation extends AwesomeSplash {
    ...
    public void initSplash(ConfigSplash configSplash) {
        ...
        //Customize Logo
        configSplash.setLogoSplash(R.drawable.webimage); //or any other drawable
        ...
        //Customize Title
        configSplash.setTitleSplash("KPIN.IN"); //change your app name here
    ...
    public void animationsFinished() {
        //Toast.makeText(FirstAnimation.this, "Going to MainActivity now!!", Toast.LENGTH_SHORT).show();
        //transit to another activity here
        //or do whatever you want
        startActivity(new Intent(FirstAnimation.this,MainActivity.class));
        FirstAnimation.this.finish();
    }
}